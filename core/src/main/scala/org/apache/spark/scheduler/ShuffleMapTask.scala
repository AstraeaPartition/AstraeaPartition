...
private[spark] class ShuffleMapTask(
    stageId: Int,
    stageAttemptId: Int,
    splitkeyPar: mutable.Map[String, Integer],
  ...
  override def runTask(context: TaskContext): MapStatus = {
    ...
    try {
      ...
      //val splitKeyPartition: mutable.Map[String, Integer] = splitkeyParBC.value
      //writer.write(rdd.iterator(partition, context).asInstanceOf[Iterator[_ <: Product2[Any, Any]]], uniqueID)
      writer.write(rdd.iterator(partition, context).asInstanceOf[Iterator[_ <: Product2[Any, Any]]], splitkeyPar.asJava, uniqueID)
