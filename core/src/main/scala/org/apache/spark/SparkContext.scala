...
class SparkContext(config: SparkConf) extends Logging {
  ...
  private var splitKeyPar: mutable.Map[String, Integer] = mutable.HashMap()
  def storeSplitKeyPar(newSplitKeyPar: mutable.HashMap[String, Integer]) = {
    splitKeyPar = newSplitKeyPar
  }
  def getSplitKeyPar(): mutable.Map[String, Integer] = {
    splitKeyPar
  }
