...
public class UnsafeShuffleWriter<K, V> extends ShuffleWriter<K, V> {
  ...
  public void write(Iterator<Product2<K, V>> records) throws IOException {
    write(JavaConverters.asScalaIteratorConverter(records).asScala(), null, "-1");
    //write(JavaConverters.asScalaIteratorConverter(records).asScala(), "-1");
  }

  @Override
  public void write(scala.collection.Iterator<Product2<K, V>> records, Map<String, Integer> splitKeyPar, String uniqueID) throws IOException {
  //public void write(scala.collection.Iterator<Product2<K, V>> records, String uniqueID) throws IOException {
